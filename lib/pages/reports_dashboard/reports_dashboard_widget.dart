...
class ReportsDashboardWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ReportsDashboardWidget> createState() =>
      _ReportsDashboardWidgetState();
}

class _ReportsDashboardWidgetState
    extends ConsumerState<ReportsDashboardWidget> {
                ...
                children: [
                  ...
                  reportsAsync.when(
                    data: (reports) {
                      ...
                      final reportsThisWeek = reports
                          .where((report) =>
                              report.createdAt != null &&
                              report.createdAt!.isAfter(startOfWeek))
                          .length;
                      ...
                      return Row(
                        children: [
                          ...
                          _buildMicroStat(
                              ...
                              AppColors.success),
                          const SizedBox(width: 8),
                          _buildMicroStat(context, 'Pending', '0',
                  ...
                  Row(
                    children: [
                      _buildActionBtn(
                          ...
                          theme.primary,
                          () => context
                              .pushNamed(DailyReportFormWidget.routeName)),
                      const SizedBox(width: 8),
                      _buildActionBtn(
                          context,
                          'History',
                      ...
                      _buildActionBtn(
                          ...
                          AppColors.success,
                          () => context
                              .pushNamed(StaffAnalyticsWidget.routeName)),
                    ],
                  ),
                  const SizedBox(height: 12),
                  ...
                  recentReportsAsync.when(
                    data: (reports) {
                      ...
                      return Column(
                        children: reports
                            .map((report) =>
                                _buildMiniReportCard(context, report, theme))
                            .toList(),
                      );
                    },
  ...
  Widget _buildMiniReportCard(
      BuildContext context, DailyReport report, FlutterFlowTheme theme) {
    return Container(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child:
                Icon(Icons.description_rounded, color: theme.primary, size: 16),
          ),
